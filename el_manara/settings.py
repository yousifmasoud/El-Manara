...
LANGUAGE_CODE = 'en-us'   # keeps admin & management commands in English
LANGUAGES = [
    ('ar', 'العربية'),
    ('en', 'English'),
]
...
# ── django-crontab ────────────────────────────────────────────────────────────
# Run daily at midnight: python manage.py crontab add
CRONJOBS = [
    ('0 0 * * *', 'accounts.tasks.expire_pending_referrals'),
]
